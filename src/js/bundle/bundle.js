...
var videoPlayer = function videoPlayer() {
  var videoOverflow = document.querySelector('.knowing__video-overlow'),
  ...
  buttonVideo.addEventListener('mouseout', function () {
  ...
  buttonVideo.addEventListener('click', function () {
    ...
    buttonVideo.removeEventListener('mouseout', function () {
      videoOverflow.style.display = 'block';
      videoKnowing.removeAttribute('controls');
    });
  });
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_videoplayer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/videoplayer.js */ "./src/js/modules/videoplayer.js");

window.addEventListener('DOMContentLoaded', function () {
  (0,_modules_videoplayer_js__WEBPACK_IMPORTED_MODULE_0__["default"])();
});
})();
